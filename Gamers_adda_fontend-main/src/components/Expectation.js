...
export default function Expectation() {
    ...
    const editPdfContantUpdate = async () => {
        ...
        try {
            ...
            const response = await fetch(`${host}/expec/expupdate`, {
                method: 'POST',
                headers: {
    ...
    const addPdfData = async () => {
        ...
        try {
            ...
            const userid = await uresponse.json();
            if (userid) {
                const response = await fetch(`${host}/expec/createexp`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    return (
        <>
            ...
            {/* <div>
                <embed src="http://res.cloudinary.com/dw5zqoz0n/image/upload/v1702825506/n2baoitna3vejvjoeweh.pdf"  /> 
                <div>loadding</div>

                <a href="http://res.cloudinary.com/dw5zqoz0n/image/upload/v1702825506/n2baoitna3vejvjoeweh.pdf" target="_blank">
                    <img src="http://res.cloudinary.com/dw5zqoz0n/image/upload/v1702825506/n2baoitna3vejvjoeweh.pdf" alt="PDF Thumbnail"/>
                </a>
            </div> */}

            {/* <object  style={{width:'400px',height:'250px'}} data="http://res.cloudinary.com/dw5zqoz0n/image/upload/v1702825506/n2baoitna3vejvjoeweh.pdf" >   </object> */}

            {/* <iframe src="http://res.cloudinary.com/dw5zqoz0n/image/upload/v1702825506/n2baoitna3vejvjoeweh.pdf" width="400px" height="500px" /> */}
